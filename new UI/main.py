...
class Admit(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle('Dawakhana')
        #self.hospital_admin.clicked.connect(self.hospital_adminUP)
        self.patient_record.clicked.connect(self.PatientRecordUP)
        self.login.clicked.connect(self.LoginUP)
        self.staff_record.clicked.connect(self.staffRecordUP)
        self.vehichle.clicked.connect(self.vehichleDutyUP)
        self.rooms.clicked.connect(self.RoomsUP)
        self.billing.clicked.connect(self.BillUP)
        self.admit.clicked.connect(self.AdmitUP)
        self.staff_duty.clicked.connect(self.staffDutyUP)
        self.revenue.clicked.connect(self.RevenueUP)
