...
try:
    client =  pymongo.MongoClient(
            'mongodb+srv://puttanpal:puttanpal@cluster0.l891v.mongodb.net/?retryWrites=true&w=majority')
    db = client["hospital"]
    admits = db["admits"]
    bills = db['bills']
...
class PatientRecord(QMainWindow):
    def __init__(self):
        ...
        stylesheetHeader = "::section{background-color: qlineargradient(spread:pad, x1:0.632, y1:0.613, x2:1, y2:0, stop:0.328358 rgba(217, 102, 111, 255), stop:0.562189 rgba(228, 134, 131, 255), stop:0.776119 rgba(242, 46, 117, 255));;border: rgba(255, 255, 255, 0.3);}"
...
class StaffDutty(QMainWindow):
    def __init__(self):
        ...
        self.populateTable()
        stylesheetHeader = "::section{background-color: qlineargradient(spread:pad, x1:0.632, y1:0.613, x2:1, y2:0, stop:0.328358 rgba(217, 102, 111, 255), stop:0.562189 rgba(228, 134, 131, 255), stop:0.776119 rgba(242, 46, 117, 255));;border: rgba(255, 255, 255, 0.3);}"
        self.DayTabel.horizontalHeader().setStyleSheet(stylesheetHeader)
        self.DayTabel.verticalHeader().setStyleSheet(stylesheetHeader)
        self.tableWidget_2.horizontalHeader().setStyleSheet(stylesheetHeader)
        self.tableWidget_2.verticalHeader().setStyleSheet(stylesheetHeader)
        # this function will fetch all the revenue data from the database
...
class StaffRecord(QMainWindow):
    def __init__(self):
        ...
        self.populateTable()
        stylesheetHeader = "::section{background-color: qlineargradient(spread:pad, x1:0.632, y1:0.613, x2:1, y2:0, stop:0.328358 rgba(217, 102, 111, 255), stop:0.562189 rgba(228, 134, 131, 255), stop:0.776119 rgba(242, 46, 117, 255));;border: rgba(255, 255, 255, 0.3);}"
        self.DetailsTable.horizontalHeader().setStyleSheet(stylesheetHeader)
        self.DetailsTable.verticalHeader().setStyleSheet(stylesheetHeader)
        # this function will fetch all the revenue data from the database
...
class VehichleDuty(QMainWindow):
    def __init__(self):
        ...
        self.populateTable()
        stylesheetHeader = "::section{background-color: qlineargradient(spread:pad, x1:0.632, y1:0.613, x2:1, y2:0, stop:0.328358 rgba(217, 102, 111, 255), stop:0.562189 rgba(228, 134, 131, 255), stop:0.776119 rgba(242, 46, 117, 255));;border: rgba(255, 255, 255, 0.3);}"
        self.PersonTable.horizontalHeader().setStyleSheet(stylesheetHeader)
        self.PersonTable.verticalHeader().setStyleSheet(stylesheetHeader)
        self.tableWidget.horizontalHeader().setStyleSheet(stylesheetHeader)
        self.tableWidget.verticalHeader().setStyleSheet(stylesheetHeader)
        # this function will fetch all the revenue data from the database
